...
Page({
    ...
    to_detail(e){
        ...
        wx.navigateTo({
            url: '../diabete_file_detail/diabete_file_detail?id=' + id + '&sick=' + sick
        });
    }
});
...
function get_visit_1(that) {
   ...
   if(sick == 7){
    ...
    let rp = that.data.rp;
    wx.request({
        url: app.global_data.ajax_url + 'platform/HYServer?requesttype=' + requesttype + '&zjhm=' + zjhm + '&page=' + page + '&rp=' + rp+'&sflb=' + 1,
        success(res) {
...
function get_visit_2(that) {
   ...
   if(sick == 7){
    ...
    let rp = that.data.rp;
    wx.request({
        url: app.global_data.ajax_url + 'platform/HYServer?requesttype=' + requesttype + '&zjhm=' + zjhm + '&page=' + page + '&rp=' + rp+'&sflb=' + 2,
        success(res) {
            let stateCode = res.data.stateCode;
            if(stateCode == 0){
                let visit = res.data.data.list;
